...
// end include: /tmp/tmpw3xa4921.js
// include: /tmp/tmpb0coc9cw.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpb0coc9cw.js
// include: /tmp/tmprc5in95l.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmprc5in95l.js
...
var ASM_CONSTS = {
  1281648: () => { if (document.fullscreenElement) return 1; },  
 1281694: () => { return document.getElementById('canvas').width; },  
 1281746: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1281814: () => { document.exitFullscreen(); },  
 1281841: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1281914: () => { if (document.fullscreenElement) return 1; },  
 1281960: () => { return document.getElementById('canvas').width; },  
 1282012: () => { return screen.width; },  
 1282037: () => { document.exitFullscreen(); },  
 1282064: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1282197: () => { return window.innerWidth; },  
 1282223: () => { return window.innerHeight; },  
 1282250: () => { if (document.fullscreenElement) return 1; },  
 1282296: () => { return document.getElementById('canvas').width; },  
 1282348: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1282416: () => { if (document.fullscreenElement) return 1; },  
 1282462: () => { return document.getElementById('canvas').width; },  
 1282514: () => { return screen.width; },  
 1282539: () => { return window.innerWidth; },  
 1282565: () => { return window.innerHeight; },  
 1282592: () => { if (document.fullscreenElement) return 1; },  
 1282638: () => { return document.getElementById('canvas').width; },  
 1282690: () => { return screen.width; },  
 1282715: () => { document.exitFullscreen(); },  
 1282742: () => { if (document.fullscreenElement) return 1; },  
 1282788: () => { return document.getElementById('canvas').width; },  
 1282840: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1282908: () => { document.exitFullscreen(); },  
 1282935: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1282993: () => { return screen.width; },  
 1283018: () => { return screen.height; },  
 1283044: () => { return window.screenX; },  
 1283071: () => { return window.screenY; },  
 1283098: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1283151: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1283222: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1283279: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1283535: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1283606: () => { if (document.fullscreenElement) return 1; },  
 1283652: () => { return window.innerWidth; },  
 1283678: () => { return window.innerHeight; },  
 1283705: () => { if (document.pointerLockElement) return 1; }
};
...
var _paste_callback = Module['_paste_callback'] = makeInvalidEarlyAccess('_paste_callback');
...
var _web_is_text_input_focused = Module['_web_is_text_input_focused'] = makeInvalidEarlyAccess('_web_is_text_input_focused');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_paste_callback'] = _paste_callback = createExportWrapper('paste_callback', 1);
  ...
  Module['_web_is_text_input_focused'] = _web_is_text_input_focused = createExportWrapper('web_is_text_input_focused', 0);
